...
arg_parser.add_argument("--min-width", default=0,
                        help="The minium width of the image")
arg_parser.add_argument("--min-height", default=0,
                        help="The minium height of the image")
arg_parser.add_argument(
    "--ratio", help="WIDTH:HEIGHT What ratio of the image you want")
...
aria2_dir = os.getcwd()+"/Downloads/"+args.keyword+"-aria2/"
if(not os.path.exists(aria2_dir)):
    os.makedirs(aria2_dir)
already_exists = []
        ...
        try:
            ...
            if args.ratio:
                ...
                if width*image_profile['height'] != height*image_profile['width']:
                    continue
            request_url = "https://www.pixiv.net/ajax/illust/" + \
                image_profile['illustId']+"/pages"
            log('Now,parsing illust: ' +
                image_profile['illustId']+'-'+image_profile['illustTitle'])
            ...
            for illust in illusts:
                ...
                image.source = "https://www.pixiv.net/artworks/" + \
                    image_profile['id']
                ...
                aria2_req=req.post(aria2_uri, json.dumps(aria2_payload))
                image.save()
            ...
            if "id" in image_profile.keys():
                log(str(image_profile), parse.unquote(
                    keyword)+'-failed_images.txt')
            else:
